...
class Ui_MenuWindow(object):
    ...
    def CreateDatabase(self):
        ...
        mycur = mydb.cursor()
        mycur.execute('Create table if not exists jm_health_care_submitted_forms(Form_Id integer primary key autoincrement not null, First_Name text not null, Last_Name text not null, Date_of_Birth text not null, Contact_Num text not null, Address text not null, Diagnosed_wt_covid text not null, Symptoms text not null)')
